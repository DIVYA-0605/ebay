    ...
    <div className="max-w-6xl mx-auto p-2">
      ...
      <section className="flex items-center space-x-2 py-5">
        <div className="h-16 w-16 sm:w-28 md:w-44 cursor-pointer flex-shrink-0">
            <Link href='/'>
                <Image className="h-full w-full object-contain" alt="Thirdweb Logo"
      ...
      <section className="flex justify-center px-6 space-x-6 text-xs md:text-sm whitespace-nowrap py-3">
