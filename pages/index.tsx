    ...
    <div className="">
      ...
      <main className="max-w-6xl mx-auto py-2 px-6">
        {loadingListings ? (
          ...
          <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-auto">
            {listings?.map((listing)=>(
              ...
              <div className="pt-2 space-y-4">
                <div>
                  ...
                  <hr/>
                  <p className="truncate text-sm text-gray-500 mt-2">{listing.asset.description}</p>
                </div>
                <p>
